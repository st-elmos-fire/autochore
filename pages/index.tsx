          ...
          {view === 'view' && (
            <>
              ...
              <Typography variant="body2" component="div" gutterBottom>
                <p>
                  This is a list of chores templates that have been added to the
                  database. This is a master list and does not reflect the
                  chores that have actually been added to users.{' '}
                </p>
                <p>
                  Deleting a chore from this list will only prevent it&apos;s
                  future creation and will not delete the chore from todoist.
                </p>
              </Typography>
              <ChoresList
                chores={choresList}
